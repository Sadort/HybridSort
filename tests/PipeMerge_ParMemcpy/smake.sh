...
/usr/local/cuda/bin/nvcc -o PipeMerge_Thrust.out -Xcompiler -fopenmp -Xcompiler -O3 PipeMerge_Thrust.cpp Thrust_kernel.o Merge_kernel.cpp -I../../include -L/usr/local/cuda/lib64 -L/usr/lib/x86_64-linux-gnu -lnvidia-ml -lcudart -lnvToolsExt -std=c++11
