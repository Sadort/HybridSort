...
/usr/local/cuda/bin/nvcc  -o BLineMulti_Bitonic.out -Xcompiler -fopenmp -Xcompiler -O3 BLineMulti_Bitonic.cpp Bitonic_kernel.o -I../../ext/inplace-gpusort -L/usr/local/cuda/lib64 -L/usr/lib/x86_64-linux-gnu -use_fast_math --expt-extended-lambda -Xptxas -dlcm=cg -lnvidia-ml -lcudart -D_FORCE_INLINES -lnvToolsExt
