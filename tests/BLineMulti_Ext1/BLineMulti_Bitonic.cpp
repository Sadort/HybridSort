...
void BitonicSort(uint64_t *h_key_array, uint64_t *d_key_array[], uint64_t number_of_elements, uint64_t batch_size, int nstreams);
...
int main(void)
{
    ...
    BitonicSort(h_key_array, d_key_array, number_of_elements, batch_size, nstreams);
