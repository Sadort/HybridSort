...
/usr/local/cuda/bin/nvcc -o BLineMulti_Thrust.out -Xcompiler -fopenmp -Xcompiler -O3 BLineMulti_Thrust.cpp Thrust_kernel.o -I../../include Merge_kernel.o -L/usr/local/cuda/lib64 -L/usr/lib/x86_64-linux-gnu -lnvidia-ml -lcudart -lnvToolsExt -std=c++11
